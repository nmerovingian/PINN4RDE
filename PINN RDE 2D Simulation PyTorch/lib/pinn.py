...
class PINN(nn.Module):
    def __init__(self, network, no_flux_bnd:bool):
        ...
        self.boundaryGrad = BoundaryGradientLayer(network)
    ...
    def forward(self, inputs):
        ...
        outputs_grads = self.grads(TYR_dmn0)
        Cdmn0, dC_dT_dmn0, dC_dY_dmn0, dC_dR_dmn0, d2C_dY2_dmn0, d2C_dR2_dmn0 = outputs_grads
        ...
        outputs_bnd1 = self.boundaryGrad(TYR_bnd1)
        Cbnd1, dC_dT_bnd1, dC_dY_bnd1, dC_dR_bnd1 = outputs_bnd1
        ...
        if self.no_flux_bnd:
            outputs_bnd4 = self.boundaryGrad(TYR_bnd4)
            Cbnd4, dC_dT_bnd4, dC_dY_bnd4, dC_dR_bnd4 = outputs_bnd4
